 ...
 */
class TrainingListForm extends sfForm {

    const MODE_MY_TRAINING_LIST = 'my_training_list';
    ...
    public function configure() {
       ...
       // $leaveStatusChoices = Leave::getStatusTextList();     
        ...
        // if ($this->mode == self::MODE_MY_Training_LIST) {
        ...
        $this->getWidgetSchema()->setNameFormat('trainingList[%s]');
