...
class TrainingRequestService extends BaseService {

    private $trainingRequestDao;

    public function getTrainingRequestDao() {
        if (!($this->trainingRequestDao instanceof TrainingRequestDao)) {
            $this->trainingRequestDao = new TrainingRequestDao();
        }
        return $this->trainingRequestDao;
    }
     ...
     * @return boolean
     */
    public function saveTrainingRequest(TrainingRequest $trainingRequest) {

        $this->getTrainingRequestDao()->saveTrainingRequest($trainingRequest);
