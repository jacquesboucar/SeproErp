 ...
 *
 */
class getChargementTableauEmpAction extends basePeformanceAction {
    ...
    public function execute($request) {
       ...
       // var_dump($request);die;
        ...
        //$result = $request->getParameter('tab');
        ...
        $notefinale=0;$nbrekpi=sizeof($rating)/2;
        $rs ='';
        $rsmodal ='';
                        ...
                        if($value->getKpi()->getKpiType() == $request->getParameter('typeindicateur')) {
                            ...
                            $rs .= '
                                ...
                                <tr>
                                   ...
                                   <td>' . $value->getPoids() . '</td>
                                   <td>' . $value->getValeurCible() . '</td>
                                   <td>' . $value->getCumule() . '</td>
                                   <td>' . round((double)(($value->getTauxAtteint() / $value->getValeurCible()) * 100), 2) . '%</td>
                                   <td>' . $value->getNote() . '</td>
                                   <td><textarea class="comment emp" id="comment_' . $value->getId() . '" name="comment[' . $value->getId() . ']" >' . $value->getComment() . '</textarea></td>
        ...
        $result = array('datars' => $rs, 'datarsmodal' => $rsmodal);
