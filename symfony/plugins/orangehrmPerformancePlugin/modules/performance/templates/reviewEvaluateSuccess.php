                                        ...
                                        <td class="rightAlign">
                                            <table border="0" class="tableauevalution">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rightAlign"><center><?php echo $rating->getKpi()->getMaxRating() ?></center></td>
                                                    <td><center><?php echo $rating->getValeurCible(); ?></center></td>
                                                    ...
                                                    <td><center><input class="rightAlign" type="text" id="mois5_<?php echo $rating->getId(); ?>" name="mois5[<?php echo $rating->getId(); ?>]" value="<?php echo $rating->getMois5(); ?>">Taux:&nbsp<?php echo ($rating->getMois5()/$rating->getValeurCible())*100; ?>%</center></td>
                                                    <td><center><input class="rightAlign" type="text" id="mois6_<?php echo $rating->getId(); ?>" name="mois6[<?php echo $rating->getId(); ?>]" value="<?php echo $rating->getMois6(); ?>">Taux:&nbsp<?php echo ($rating->getMois6()/$rating->getValeurCible())*100; ?>%</center></td>
                                                    <td><center><input class="rightAlign" type="text" id="mois7_<?php echo $rating->getId(); ?>" name="mois7[<?php echo $rating->getId(); ?>]" value="<?php echo $rating->getMois7(); ?>">Taux:&nbsp<?php echo ($rating->getMois7()/$rating->getValeurCible())*100; ?>%</center></td>
                                                    <td><center><input class="rightAlign" type="text" id="mois8_<?php echo $rating->getId(); ?>" name="mois8[<?php echo $rating->getId(); ?>]" value="<?php echo $rating->getMois8(); ?>">Taux:&nbsp<?php echo ($rating->getMois8()/$rating->getValeurCible())*100; ?>%</center></td>
