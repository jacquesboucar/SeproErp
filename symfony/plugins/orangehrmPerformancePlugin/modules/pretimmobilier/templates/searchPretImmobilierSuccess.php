...
<div class="box searchForm toggableForm" id="divFormContainer">
    <div class="head">
        <h1><?php echo __('Search Pret Immobilier'); ?></h1>
    </div>

    <div class="inner">

        <form id="searchPretImmobilier" name="searchPretImmobilier" method="post" action="">
            <fieldset>
                <ol>
...
<script>
    ...
    function addKpi(){
        document.location.href = "<?php echo public_path('index.php/pretimmobilier/savePretImmobilier'); ?>";
    }
</script>