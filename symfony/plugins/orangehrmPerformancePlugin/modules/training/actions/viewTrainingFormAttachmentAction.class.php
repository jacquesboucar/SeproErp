 ...
 * @author orangehrm
 */
class viewTrainingFormAttachmentAction extends sfAction {
    ...
    public function execute($request) {
        ...
        if (!empty($attachment)) {
            $contents = $attachment->getFormFilecontent();
            $contentType = $attachment->getFormFiletype();
            $fileName = $attachment->getFormFilename();
            $fileLength = $attachment->getFormFilesize();
