...
<div class="box searchForm toggableForm" id="divFormContainer">
    ...
    <div class="inner">
        ...
        <form id="searchTraining" name="searchTraining" method="post" action="">
            <fieldset>
                <ol>
...
<script>
    ...
    function addKpi(){
        document.location.href = "<?php echo public_path('index.php/training/saveTraining'); ?>";
    }
</script>