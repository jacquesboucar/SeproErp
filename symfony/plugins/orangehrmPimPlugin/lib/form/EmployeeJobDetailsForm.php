...
class EmployeeJobDetailsForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setValidators(array(
            ...
            'mission' => new sfValidatorString(array('required' => true,'required' => true)),
            'activite' => new sfValidatorString(array('required' => true,'required' => true)),
            'comment' => new sfValidatorString(array('required' => true,'required' => false)),
            'relation' => new sfValidatorString(array('required' => true,'max_length' => 255)),
            'formation' => new sfValidatorString(array('required' => true,'max_length' => 255)),
            'exp' => new sfValidatorString(array('required' => true,'max_length' => 255)),
            'competence' => new sfValidatorString(array('max_length' => 1000)),
            'sigle' => new sfValidatorString(array('required' => true,'max_length' => 255)),
            'entite'  => new sfValidatorString(array('required' => true,'max_length' => 255)),
            'version' => new sfValidatorString(array('required' => true,'max_length' => 255)),
            'remplacant' => new sfValidatorString(array('required' => true,'max_length' => 255)),
